...
class WebUIPWATests(unittest.TestCase):
    ...
    def test_service_worker_caches_only_application_shell_not_user_data_or_api_streams(self) -> None:
        ...
        self.assertIn('const CACHE_NAME = "ilab-conjure-shell-v111";', source)
        self.assertIn('"/"', source)
        self.assertIn('"/history"', source)
        self.assertIn('"/manifest.webmanifest"', source)
        self.assertIn('"/static/app.js?v=runtime-643"', source)
        self.assertIn('"/static/history.js?v=history-71"', source)
        self.assertIn('"/static/styles.css?v=runtime-643"', source)
...
let responsePromise;
listeners.get("fetch")({{
  request: {{ method: "GET", mode: "same-origin", url: "https://image.test/static/app.js?v=runtime-643" }},
