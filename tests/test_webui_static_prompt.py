...
"""
    ...
    def test_api_direct_mode_hides_non_applicable_main_model_but_keeps_prompt_fidelity(self) -> None:
        ...
        self.assertIn("const showModeSettings = visibility.showMainModel;", script)
        self.assertNotIn("|| visibility.showApiDirectNotice", script)
        self.assertNotIn("|| visibility.showPromptFidelity", script)
