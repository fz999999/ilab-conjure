...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-644", index)
        self.assertIn("runtime-644", history)
        self.assertIn("history-71", history)
        self.assertIn('ilab-conjure-shell-v112', worker)
        self.assertIn('/static/app.js?v=runtime-644', worker)
        self.assertIn('/static/styles.css?v=runtime-644', worker)
