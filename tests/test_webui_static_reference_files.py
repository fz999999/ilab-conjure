...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-642", index)
        self.assertIn("runtime-642", history)
        self.assertIn("history-71", history)
        self.assertIn('ilab-conjure-shell-v110', worker)
        self.assertIn('/static/app.js?v=runtime-642', worker)
        self.assertIn('/static/styles.css?v=runtime-642', worker)
