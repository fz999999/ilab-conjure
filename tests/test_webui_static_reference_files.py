...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-643", index)
        self.assertIn("runtime-643", history)
        self.assertIn("history-71", history)
        self.assertIn('ilab-conjure-shell-v111', worker)
        self.assertIn('/static/app.js?v=runtime-643', worker)
        self.assertIn('/static/styles.css?v=runtime-643', worker)
