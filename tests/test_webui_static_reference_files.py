...
class ReferenceFileFrontendContractTests(unittest.TestCase):
    ...
    def test_cache_versions_are_bumped_once(self) -> None:
        ...
        self.assertIn("runtime-647", index)
        self.assertIn("runtime-647", history)
        self.assertIn("history-72", history)
        self.assertIn('ilab-conjure-shell-v115', worker)
        self.assertIn('/static/app.js?v=runtime-647', worker)
        self.assertIn('/static/styles.css?v=runtime-647', worker)
